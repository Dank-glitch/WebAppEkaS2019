...
namespace WebAppEkaS2019.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult Laskuri()
        {
            string ilmoitus = "";
            int i = 0;
            string connStr = "Server=LAPTOP-DABAJHQU\\SQLEXPRESS;Database=northwind;Trusted_Connection=False;User Id=sa;Password=labyrintti333;"; //<--oman koneen SQL Serverin sekä tietokannan nimi
